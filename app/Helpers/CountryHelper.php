...
{
    /**
     * Map of ISO 3166-1 alpha-2 codes to international dial codes.
     */
    protected static $dialCodes = [
     ...
     * @return string
     */
    public static function getDialCode(?string $isoCode, string $default = '966'): string
    {
        if (empty($isoCode)) {
            return $default;
        }
        ...
        return self::$dialCodes[$isoCode] ?? $default;
    }
}
