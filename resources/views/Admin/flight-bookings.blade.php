                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-600 dark:text-gray-400">
                                        ...
                                        @if ($booking->originAirport && $booking->originAirport->iata)
                                            ({{ $booking->originAirport->iata }})
                                        @endif
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-600 dark:text-gray-400">
                                        ...
                                        @if ($booking->destinationAirport && $booking->destinationAirport->iata)
                                            ({{ $booking->destinationAirport->iata }})
                                        @endif
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-600 dark:text-gray-400">
                                        {{ $booking->departure_date->format('M d, Y') }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <form method="POST"
                                        action="{{ route('admin.flight-bookings.update-status', ['locale' => app()->getLocale(), 'flightBooking' => $booking->id]) }}"
