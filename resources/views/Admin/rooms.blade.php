...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">{{ __('Hotel') }}</label>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="relative h-48 bg-gradient-to-br from-blue-500 to-blue-600">
                ...
                <div class="absolute top-4 {{ app()->getLocale() === 'ar' ? 'right-4' : 'left-4' }}">
                    <span class="px-3 py-1 bg-green-500 text-white rounded-full text-xs font-semibold">{{ __('Available') }}</span>
                </div>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <div class="text-sm font-semibold text-gray-900 dark:text-white">{{ __('International Luxury Hotel') }}</div>
                    </div>
                    <div class="text-right">
                        <div class="text-sm text-gray-600 dark:text-gray-400">{{ __('Price') }}</div>
                        <div class="text-lg font-bold text-orange-600 dark:text-orange-400">SAR 350</div>
                    </div>
                </div>
                
                <div class="flex flex-wrap gap-2 mb-4">
                    <span class="px-2 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-xs rounded-lg">
                        <i class="fas fa-bed {{ app()->getLocale() === 'ar' ? 'ml-1' : 'mr-1' }}"></i>2 {{ __('Beds') }}
                    </span>
                    <span class="px-2 py-1 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-xs rounded-lg">
                        <i class="fas fa-users {{ app()->getLocale() === 'ar' ? 'ml-1' : 'mr-1' }}"></i>4 {{ __('Guests') }}
                    </span>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="relative h-48 bg-gradient-to-br from-green-500 to-green-600">
                <img src="https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
                     alt="Room" class="w-full h-full object-cover opacity-80">
                <div class="absolute top-4 {{ app()->getLocale() === 'ar' ? 'right-4' : 'left-4' }}">
                    <span class="px-3 py-1 bg-orange-500 text-white rounded-full text-xs font-semibold">{{ __('Occupied') }}</span>
                </div>
                <div class="absolute bottom-4 {{ app()->getLocale() === 'ar' ? 'right-4' : 'left-4' }}">
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <div class="text-sm text-gray-600 dark:text-gray-400">{{ __('Hotel') }}</div>
                        <div class="text-sm font-semibold text-gray-900 dark:text-white">{{ __('Comfort & Relaxation Hotel') }}</div>
                    </div>
                    <div class="text-right">
                        <div class="text-sm text-gray-600 dark:text-gray-400">{{ __('Price') }}</div>
                        <div class="text-lg font-bold text-orange-600 dark:text-orange-400">SAR 280</div>
                    </div>
                </div>
                
                <div class="flex flex-wrap gap-2 mb-4">
                    <span class="px-2 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-xs rounded-lg">
                        <i class="fas fa-bed {{ app()->getLocale() === 'ar' ? 'ml-1' : 'mr-1' }}"></i>1 {{ __('Bed') }}
                    </span>
                    <span class="px-2 py-1 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-xs rounded-lg">
                        <i class="fas fa-users {{ app()->getLocale() === 'ar' ? 'ml-1' : 'mr-1' }}"></i>2 {{ __('Guests') }}
                    </span>
                    <span class="px-2 py-1 bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 text-xs rounded-lg">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="relative h-48 bg-gradient-to-br from-purple-500 to-purple-600">
                <img src="https://images.unsplash.com/photo-1571896349842-33c89424de2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
                     alt="Room" class="w-full h-full object-cover opacity-80">
                <div class="absolute top-4 {{ app()->getLocale() === 'ar' ? 'right-4' : 'left-4' }}">
                    <span class="px-3 py-1 bg-red-500 text-white rounded-full text-xs font-semibold">{{ __('Maintenance') }}</span>
                </div>
                <div class="absolute bottom-4 {{ app()->getLocale() === 'ar' ? 'right-4' : 'left-4' }}">
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <div class="text-sm text-gray-600 dark:text-gray-400">{{ __('Hotel') }}</div>
                        <div class="text-sm font-semibold text-gray-900 dark:text-white">{{ __('Premium Stay Hotel') }}</div>
                    </div>
                    <div class="text-right">
                        <div class="text-sm text-gray-600 dark:text-gray-400">{{ __('Price') }}</div>
                        <div class="text-lg font-bold text-orange-600 dark:text-orange-400">SAR 420</div>
                    </div>
                </div>
