...
<body class="font-cairo antialiased">
    ...
    <a href="https://wa.me/966500000000?text=مرحباً، أريد الاستفسار عن حجز فندق" 
       ...
       class="fixed bottom-6 left-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-2xl transition-all duration-300 hover:scale-110 group">
        ...
        <span class="absolute right-full mr-3 transform -translate-y-1/2 bg-gray-900 text-white px-4 py-2 rounded-lg text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full mx-4 my-8 relative" id="modalContent">
            ...
            <div id="loginForm" class="p-6 max-w-md mx-auto">
                ...
                <form onsubmit="handleLogin(event)">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="#" class="text-sm text-orange-500 hover:underline">نسيت كلمة المرور؟</a>
                    </div>
            ...
            <div id="registerForm" class="hidden">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-0 min-h-[500px]">
                    ...
                    <section class="p-8 flex flex-col items-center justify-center bg-gradient-to-br from-orange-50 via-orange-100 to-blue-50 border-l md:border-l-0 md:border-r border-gray-200">
                        <div class="w-full max-w-sm">
                            <h3 class="text-2xl font-bold text-gray-900 mb-3 text-center">سجل باستخدام</h3>
                            <p class="text-gray-600 text-sm mb-8 text-center">استخدم حسابك الاجتماعي للتسجيل السريع</p>
                            <div class="w-full space-y-3">
                                ...
                                <button type="button" class="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 text-gray-700 py-3.5 rounded-xl font-semibold hover:bg-gray-50 hover:border-orange-500 hover:text-orange-500 transition shadow-md">
                                    ...
                                    <span>التسجيل بحساب Facebook</span>
                                </button>
                                <button type="button" class="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 text-gray-700 py-3.5 rounded-xl font-semibold hover:bg-gray-50 hover:border-orange-500 hover:text-orange-500 transition shadow-md">
                                    <i class="fab fa-apple text-xl text-gray-900"></i>
                                    <span>التسجيل بحساب Apple</span>
                                </button>
                                <button type="button" class="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 text-gray-700 py-3.5 rounded-xl font-semibold hover:bg-gray-50 hover:border-orange-500 hover:text-orange-500 transition shadow-md">
                                    <i class="fab fa-twitter text-xl text-blue-400"></i>
                                    <span>التسجيل بحساب Twitter</span>
                                </button>
                            </div>
                        </div>
                    </section>
                            ...
                            <form onsubmit="handleRegister(event)">
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" name="phone" required placeholder="05xxxxxxxx" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-gray-900">
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 font-semibold mb-2">كلمة المرور</label>
