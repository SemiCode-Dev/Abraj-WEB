...
@section('content')
    ...
    <section class="relative h-96 overflow-hidden">
        ...
        <div class="absolute bottom-0 left-0 right-0 p-8 text-white">
            ...
            @if($package->price)
                <p class="text-2xl font-bold text-orange-400">{{ number_format($package->price, 2) }} {{ __('SAR') }}</p>
            @endif
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    ...
                    @if($package->locale_details)
                        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">{{ __('Package Details') }}</h2>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 sticky top-24">
                        ...
                        <form action="{{ route('package.contact', ['id' => $package->id, 'locale' => app()->getLocale()]) }}" method="POST">
                            @csrf
                            ...
                            @else
                                <div class="mb-4 p-4 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg">
                                    <p class="text-sm text-blue-700 dark:text-blue-300">
                                        ...
                                        {{ __('We will use your account information') }}
                                    </p>
