                ...
                <form action="{{ route('visa.book') }}" method="POST" class="space-y-6">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="nationality_id" required
                            class="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-gray-100 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-gray-900 dark:text-gray-100 bg-white appearance-none cursor-pointer">
                            <option value="">{{ __('Select Nationality') }}</option>
                            @foreach ($countries as $country)
                                @if ($country->locale_nationality)
