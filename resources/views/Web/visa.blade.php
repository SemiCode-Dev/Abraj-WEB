            ...
            <form action="{{ route('visa.book') }}" method="POST" class="space-y-6">
                ...
                <div class="mb-6">
                    ...
                    <select name="visa_type" required
                        ...
                        <option value="transit" {{ old('visa_type') == 'transit' ? 'selected' : '' }}>{{ __('Transit Visa') }}</option>
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="duration" value="{{ old('duration') }}" required min="1" max="365"
                ...
                <div class="mb-6">
                    ...
                    <textarea name="comment" rows="4"
                              placeholder="{{ __('Enter any additional comments or requirements') }}"
